...
# provided - first, you read the dimensions and then the data.
...
# coordinates are not valid), print "Invalid input!" and move on to the following command. A negative value makes the coordinates not valid.
